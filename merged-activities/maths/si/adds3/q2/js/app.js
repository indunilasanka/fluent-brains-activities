...
/* LOGIC */
function q37checkTotalValue(id, actual) {
...
function q37checkMissingValuesAll() {
    let isCorrect = true;
...
function switchQuestion(){
    window.location.replace("/maths/en/adds3/q3/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds3-q2", score);

    let newScore = Number(sessionStorage.getItem("adds3-q1")) + Number(score);
