...
/* LOGIC */
function q32checkTotalValue(id, actual) {
...
function q32checkMissingValuesAll() {
    let isCorrect = true;
...
function switchQuestion(){
    window.location.replace("/maths/en/adds4/q2/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds4-q1", score);
