...
/* LOGIC */
function q8handleAnswerClick(id, num) {
...
function setScore(){
    let score = Number(sessionStorage.getItem("adds2-q1"))
        ...
        + Number(sessionStorage.getItem("adds2-q4"));
...
function switchQuestion(){
    window.location.replace("/maths/si/adds2/q1/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds2-q5", score);

    let newScore = Number(sessionStorage.getItem("adds2-q1"))
        + Number(sessionStorage.getItem("adds2-q2"))
        + Number(sessionStorage.getItem("adds2-q3"))
        + Number(sessionStorage.getItem("adds2-q4")) + Number(score);
