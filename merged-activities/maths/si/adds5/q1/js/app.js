...
/* LOGIC */
function q27checkTotalValue(id, actual) {
...
function q27checkMissingValuesAll() {
    let isCorrect = true;
...
function switchQuestion(){
    window.location.replace("/maths/en/adds5/q2/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds5-q1", score);
