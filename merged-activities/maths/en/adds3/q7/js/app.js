...
/* LOGIC */
function q65CheckTotalValue(id, actual) {
...
function q65CheckMissingValuesAll(qId) {
    let isCorrect = true;
    if (qId === 'q65') {
        const input1 = document.getElementById('q65input1');
        const input2 = document.getElementById('q65input2');
        const input3 = document.getElementById('q65input3');
        const input4 = document.getElementById('q65input4');
...
function setScore(){
    let score = Number(sessionStorage.getItem("adds3-q1"))
        ...
        + Number(sessionStorage.getItem("adds3-q3"))
        + Number(sessionStorage.getItem("adds3-q4"))
        + Number(sessionStorage.getItem("adds3-q5"))
        + Number(sessionStorage.getItem("adds3-q6"));
...
function switchQuestion(){
    window.location.replace("/maths/en/adds3/q1/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds3-q7", score);
    ...
    let newScore = Number(sessionStorage.getItem("adds3-q1"))
        ...
        + Number(sessionStorage.getItem("adds3-q4"))
        + Number(sessionStorage.getItem("adds3-q5"))
        + Number(sessionStorage.getItem("adds3-q6")) + Number(score);
