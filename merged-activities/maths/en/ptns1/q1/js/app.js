...
function switchQuestion(){
    window.location.replace("/maths/en/ptns1/q2/index.html");
}
...
function submitAnswerQ1() {
    let isCorrect = true;

    const block1 = document.getElementById("p1block7").children;
    if (block1[0].getAttribute("canswer") !== "p1-4") {
        isCorrect = false;
    }

    const block2 = document.getElementById("p1block8").children;
    if (block2[0].getAttribute("canswer") !== "p1-2") {
        isCorrect = false;
    }

    const p2block7 = document.getElementById("p2block7").children;
    if (p2block7[0].getAttribute("canswer") !== "p2-4") {
        isCorrect = false;
    }

    const p2block8 = document.getElementById("p2block8").children;
    if (p2block8[0].getAttribute("canswer") !== "p2-2") {
        isCorrect = false;
    }
