...
function switchQuestion(){
    window.location.replace("/maths/en/ptns2/q3/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("ptns2-q2", score);

    let newScore = Number(sessionStorage.getItem("ptns2-q1")) + Number(score);
...
function submitAnswerQ2() {
    ...
    let answer1 = document.getElementById("q2-box-one").value;
    let answer2 = document.getElementById("q2-box-two").value;

    if (answer1 !== "25" && answer1 !== "") {
        isCorrect = false;
    }
    if (answer1 === "") {
        isCorrect = false;
    ...
    if (answer1 === "25" && answer2 !== "109") {
        isCorrect = false;
    }

    if (answer2 === "109" && answer1 !== "25") {
        isCorrect = false;
    }
