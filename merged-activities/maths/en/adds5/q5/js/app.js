...
/* LOGIC */
function q4CheckTotalValue(id, actual) {
...
function q4CheckMissingValuesAll(qId) {
    let isCorrect = true;
    if (qId === 'q4') {
...
function setScore(){
    let score = Number(sessionStorage.getItem("adds5-q1"))
        + Number(sessionStorage.getItem("adds5-q2"))
        + Number(sessionStorage.getItem("adds5-q3"))
        + Number(sessionStorage.getItem("adds5-q4"));
...
function switchQuestion(){
    window.location.replace("/maths/en/adds5/q1/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds5-q5", score);

    let newScore = Number(sessionStorage.getItem("adds5-q1"))
        + Number(sessionStorage.getItem("adds5-q2"))
        + Number(sessionStorage.getItem("adds5-q3"))
        + Number(sessionStorage.getItem("adds5-q4")) + Number(score);
