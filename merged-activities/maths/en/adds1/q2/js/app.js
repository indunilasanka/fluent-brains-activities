...
/* LOGIC */
function q10checkTotalValue(id, actual) {
...
function q10checkMissingValuesAll() {
    let isCorrect = true;
...
function switchQuestion(){
    window.location.replace("/maths/en/adds1/q3/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds1-q2", score);

    let newScore = Number(sessionStorage.getItem("adds1-q1")) + Number(score);
