...
// q9
var q9Row1ClickedWord = "";
var container = document.getElementById("q9-ans-cnt");

if (container != null) {
  var btns1 = container.getElementsByClassName("maya-blue");

  for (var i = 0; i < btns1.length; i++) {
    btns1[i].addEventListener("click", function () {
      q9Row1ClickedWord = this.id;


        var current = document.getElementsByClassName(
        "q9-word-container-clicked"
      );
      if (current.length === 0) {
        this.className += " q9-word-container-clicked";
      } else {
