...
var q10ClickedLetter = "";
var container = document.getElementById("q10-letter-container");

if (container != null) {
  var btns = container.getElementsByClassName("q10-letter");
  for (var i = 0; i < btns.length; i++) {
    btns[i].addEventListener("click", function () {
      q10ClickedLetter = this.innerHTML;

      var current = document.getElementsByClassName("q10-letter-clicked");
      if (current.length === 0) {
        this.className += " q10-letter-clicked";
      } else {
...
function q10SubmitAnswer() {
  if (q10ClickedLetter === "m") {
    openPopup();
  } else {
    reduceStarCount();
  }
