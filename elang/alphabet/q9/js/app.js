...
function q9SubmitAnswer() {
  ...
  block = document.getElementById("q9-answer-drop-box-container");
  c = block.children;
  ...
  for (var i = 0; i < c.length; i++) {
    ...
    if (c[i].children[0].getAttribute("canswer") != ansTrack2) {
      reduceStarCount();
      cansdiv = document.getElementById("q9" + ansTrack2);
      setTimeout(() => {
        if (c[i].children[0].className === "q9-answer-box-drop-div") {
