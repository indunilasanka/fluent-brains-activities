...
var q4Answer = "";
var q4container = document.getElementById("q4-answerId");
var q4buttons = q4container.getElementsByClassName("q4-answer-button");

for (var i = 0; i < q4buttons.length; i++) {
    q4buttons[i].addEventListener("click", function () {
        q4Answer = this.innerHTML;

        var current1 = document.getElementsByClassName("q4-answer-check");
        if (current1.length === 0) {
            this.className += " q4-answer-check";
        } else {
