...
/* LOGIC */
function q7answerCheck(id) {
    let input = document.getElementById(id);
    if (input.classList.value === "q7-check-box") {
...
function q7Submit() {
    ...
    if (
        input1.className === "q7-check-box check-color" ||
        input3.className === "q7-check-box check-color" ||
        input4.className === "q7-check-box check-color"
    ) {
        ...
        reduceStarCount();
    } else if (input2.className === "q7-check-box check-color") {
        openPopup();
    } else {
        let styleClasses = document.getElementById("qpanel").classList;
        styleClasses.add("incorrect-answer");
