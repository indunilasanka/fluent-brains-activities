...
var q2buttons1 = q2container1.getElementsByClassName("q2-answer-name");
for (var i = 0; i < q2buttons1.length; i++) {
    q2buttons1[i].addEventListener("click", function () {
        ...
        var current1 = document.getElementsByClassName("q2-answer-check1");
        //console.log(current1);
        if (current1.length === 0) {
            this.className += " q2-answer-check1";
...
var q2buttons2 = q2container2.getElementsByClassName("q2-answer-name");

for (let j = 0; j < q2buttons2.length; j++) {
    q2buttons2[j].addEventListener("click", function () {
        q2Answer2 = this.innerHTML;

        var current = document.getElementsByClassName("q2-answer-check2");
        if (current.length === 0) {
            this.className += " q2-answer-check2";
        } else {
...
function q2HandleSubmit() {
    if (
        q2Answer1 === "Octahedron" &&
        q2Answer2 === "Tetrahedron"
    ) {
        openPopup();
    } else {
