...
function q5answerCheck(id) {
    ...
    if (input.classList.value === "q5-check-box") {
...
function q5Submit() {
    ...
    if (
        input1.className === "q5-check-box check-color" ||
        input2.className === "q5-check-box check-color" ||
        input4.className === "q5-check-box check-color"
    ) {
        ...
        reduceStarCount();
    } else if (input3.className === "q5-check-box check-color") {
        openPopup();
    } else {
        let styleClasses = document.getElementById("qpanel").classList;
        styleClasses.add("incorrect-answer");
