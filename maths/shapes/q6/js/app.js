...
/* LOGIC */
function q6answerCheck(id) {
    let input = document.getElementById(id);
    if (input.classList.value === "q6-check-box") {
...
function q6Submit() {
    ...
    if (
        input1.className === "q6-check-box check-color" ||
        input4.className === "q6-check-box check-color"
    ) {
        ...
        reduceStarCount();
    } else if (input3.className === "q6-check-box check-color" && input2.className === "q6-check-box check-color") {
        openPopup();
    } else {
        let styleClasses = document.getElementById("qpanel").classList;
        styleClasses.add("incorrect-answer");
