...
/* LOGIC */
function q29checkTotalValue(id, actual) {
...
function q29checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q29input1');
    const input2 = document.getElementById('q29input2');
    const input3 = document.getElementById('q29input3');
    if (input1.value != '2') {
