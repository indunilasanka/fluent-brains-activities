...
/* LOGIC */
function q25handleAnswerClick(id, num) {
...
function switchQuestion(){
    window.location.replace("/maths/en/adds5/q4/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds5-q3", score);

    let newScore = Number(sessionStorage.getItem("adds5-q1"))
        + Number(sessionStorage.getItem("adds5-q2")) + Number(score);
