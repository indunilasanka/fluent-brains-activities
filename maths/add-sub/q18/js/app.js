...
/* LOGIC */
function q18checkTotalValue(id, actual) {
...
function q18checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q18input1');
    const input2 = document.getElementById('q18input2');
    const input3 = document.getElementById('q18input3');
    const input4 = document.getElementById('q18input4');
    const input5 = document.getElementById('q18input5');
    if (input1.value != '8') {
