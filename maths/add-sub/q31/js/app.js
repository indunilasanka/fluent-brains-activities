...
/* LOGIC */
function q31checkTotalValue(id, actual) {
...
function q31checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q31input1');
    const input2 = document.getElementById('q31input2');
    const input3 = document.getElementById('q31input3');
    const input4 = document.getElementById('q31input4');
    if (input1.value != '4') {
