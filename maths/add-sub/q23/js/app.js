...
/* LOGIC */
function q23checkTotalValue(id, actual) {
...
function q23checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q23input1');
    const input2 = document.getElementById('q23input2');
    if (input1.value != '6') {
