...
/* LOGIC */
function q28checkTotalValue(id, actual) {
...
function q28checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q28input1');
    const input2 = document.getElementById('q28input2');
    if (input1.value != '7') {
