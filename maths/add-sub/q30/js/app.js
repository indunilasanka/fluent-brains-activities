...
/* LOGIC */
function q30checkTotalValue(id, actual) {
...
function q30checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q30input1');
    const input2 = document.getElementById('q30input2');
    const input3 = document.getElementById('q30input3');
    const input4 = document.getElementById('q30input4');
    const input5 = document.getElementById('q30input5');
    if (input1.value != '3') {
