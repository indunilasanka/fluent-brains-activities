...
/* LOGIC */
function q20checkTotalValue(id, actual) {
...
function q20checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q20input1');
    const input2 = document.getElementById('q20input2');
    if (input1.value != '2') {
