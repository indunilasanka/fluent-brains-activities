...
function setScore(){
    let score = Number(sessionStorage.getItem("adds1-q1"))
        + Number(sessionStorage.getItem("adds1-q2"))
        + Number(sessionStorage.getItem("adds1-q3"));
...
function switchQuestion(){
    window.location.replace("/maths/en/adds1/q1/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("adds1-q4", score);

    let newScore = Number(sessionStorage.getItem("adds1-q1"))
        + Number(sessionStorage.getItem("adds1-q2"))
        + Number(sessionStorage.getItem("adds1-q3")) + Number(score);
