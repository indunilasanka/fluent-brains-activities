...
/* LOGIC */
function q19checkTotalValue(id, actual) {
...
function q19checkMissingValuesAll() {
    let isCorrect = true;
    const input1 = document.getElementById('q19input1');
    const input2 = document.getElementById('q19input2');
    if (input1.value != '2') {
