...
function submitAnswerq12() {
    let isCorrect = false;
    const block = document.getElementById("q12button");
    let children = block.children;

    if (children[0].getAttribute("canswer") !== "19") {
        isCorrect = false;
    } else if (children[1].getAttribute("canswer") !== "16") {
        isCorrect = false;
    } else if (children[2].getAttribute("canswer") !== "14") {
        isCorrect = false;
    } else if (children[3].getAttribute("canswer") !== "11") {
        isCorrect = false;
    } else if (children[4].getAttribute("canswer") !== "9") {
        isCorrect = false;
    } else {
        isCorrect = true;
    }
