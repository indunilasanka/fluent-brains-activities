...
function submitAnswerQ7() {
    let isCorrect = false;
    const block = document.getElementById("q7button");
    let children = block.children;

    if (children[0].getAttribute("canswer") !== "3") {
        isCorrect = false;
    } else if (children[1].getAttribute("canswer") !== "4") {
        isCorrect = false;
    } else if (children[2].getAttribute("canswer") !== "6") {
        isCorrect = false;
    } else if (children[3].getAttribute("canswer") !== "7") {
        isCorrect = false;
    } else if (children[4].getAttribute("canswer") !== "10") {
        isCorrect = false;
    } else {
        isCorrect = true;
    }
