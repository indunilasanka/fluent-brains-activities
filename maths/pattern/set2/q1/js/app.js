...
function switchQuestion(){
    window.location.replace("/maths/en/ptns2/q2/index.html");
}

function calculateScore() {
    let score = (starCount * scoreFactor) / (second + minute * 60 + hour * 3600);
    score = score.toFixed(2);
    sessionStorage.setItem("ptns2-q1", score);
...
function submitAnswerq8() {
    ...
    let answer1 = document.getElementById("q8-box-one").value;
    let answer2 = document.getElementById("q8-box-two").value;
    ...
    if (answer1 === "19" && answer2 !== "23") {
        isCorrect = false;
    }

    if (answer2 === "23" && answer1 !== "19") {
        isCorrect = false;
    }
