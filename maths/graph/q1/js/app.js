...
function drag(event) {
    ...
    let elements = document.getElementsByClassName("drop-area");
    for (let i = 0; i < elements.length; i++) {
        elements[i].classList.add("drop-border");
    }
}
...
function dragEnd(event) {
    let elements = document.getElementsByClassName("drop-area");
    for (let i = 0; i < elements.length; i++) {
        elements[i].classList.remove("drop-border");
    }
}

function clearDragBorder(){
    let elements = document.getElementsByClassName("q1-drag-img");
    for (let i = 0; i < elements.length; i++) {
        elements[i].children[0].classList.remove("drop-area");
        elements[i].children[0].classList.remove("drop-border");
    }
}
